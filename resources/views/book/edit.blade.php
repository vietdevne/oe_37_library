...
@section('content')
<h2 class="mt-4 mb-4">@lang('admin.book.edit')</h2>
@if ($errors->any())
...
@endif
<form class="form-horizontal bg-white pt-4 pb-4 pl-2 pr-2" method="POST" action="{{ route('admin.books.update', $book->book_id) }}" enctype="multipart/form-data">
    {{ csrf_field() }}
    {{ method_field('PUT') }}
    <div class="form-group">
        <label for="book_title" class="col-md-4 control-label">@lang('admin.book.title')</label>
        <div class="col-md-12">
            <input id="book_title" type="text" class="form-control{{ $errors->has('cate_name') ? ' is-invalid' : '' }}" name="book_title" value="{{ $book->book_title }}">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input id="quantity" name="quantity" type="number" class="form-control{{ $errors->has('quantity') ? ' is-invalid' : '' }}" value="{{ $book->quantity }}">
    ...
    <div class="form-group">
        ...
        <div class="col-md-12">
            <textarea id="book_desc" cols="12" class="form-control{{ $errors->has('book_desc') ? ' is-invalid' : '' }}" name="book_desc">{{ $book->book_desc }}</textarea>
